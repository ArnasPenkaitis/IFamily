...
public class Notes extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_todonotes, container, false);
        ...
        FloatingActionButton fab = rootView.findViewById(R.id.fabtodonotes);
        ...
        database.collection("Notes").whereEqualTo("familyid",familyID).whereEqualTo("type",true).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
